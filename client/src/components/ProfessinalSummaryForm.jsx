...
const ProfessinalSummaryForm = ({data,onChange, setResumeData}) => {
    ...
    const generateSummary = async () => {
        try {
            ...
            toast.error(error?.response?.data?.message || error.message || "An error occurred while generating summary. Please try again.")
        }
        finally{
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            ...
            placeholder='White a complelling professinal summary that highlights your key stengths and career objectives...'/>
