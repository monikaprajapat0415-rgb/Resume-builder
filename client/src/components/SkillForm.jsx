...
const SkillForm = ({ data, onChange }) => {
    ...
    const removeSkill = (indexToRemove) => {
        const updatedSkills = data.filter((_, i) => i !== indexToRemove);
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='flex gap-2'>
                <input type='text' placeholder='Enter a skill (e.g., JavaScript, Java )' className='flex-1 px-3 py-2 text-sm'
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
                <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relevant skills that align with the job you're applying for. Include a mix of technical skills (e.g., programming languages, tools) and soft skills (e.g., communication, teamwork).
